...
public class JournalActivity extends AppCompatActivity implements JournalHistoryAdapter.OnCardClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        journalGrid= findViewById(R.id.journalGrid);
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if(journalList != null){
                            journalList.observe(lifecycleOwner, new Observer<List<Journal>>() {
                                @Override
